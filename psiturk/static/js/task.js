...
let InstructionRunner = function (condition_list) {
    ...
    // let first_part = condition_list["first_part"];
    let page = new InstructionPage();
    // let page = new InstructionPage(EXPERIMENT_PART, first_part);
...
// let Quiz = function (goBack, goNext, first_part) {
    ...
    function is_quiz_cleared() {
        ...
        //     if (first_part === "action" && question_2.value !== 'a') {
        //         quiz_cleared = false;
        //     }
        //
        //     if (first_part === "goal" && question_2.value !== 'b') {
        //         quiz_cleared = false;
        //     }
        // } else {
        //     if (first_part === "action" && question_2.value !== 'b') {
        //         quiz_cleared = false;
        //     }
        //
        //     if (first_part === "goal" && question_2.value !== 'a') {
        //         quiz_cleared = false;
        //     }
        // }
...
let Experiment = function (condition_list) {
    ...
    // let trial_page = new TrialPage(trial_data, EXPERIMENT_PART);
    ...
    let run_single_trial = function (curr_trial_page_index) {
        ...
        // if (EXPERIMENT_PART === 1 && first_part === "action") {
        //     true_stimulus_length = 20;
        // } else if (EXPERIMENT_PART === 2 && first_part === "goal") {
        //     true_stimulus_length = 20;
        // }
        //
        // if (trial_page.getCurrentTrialDisplayNum() >= true_stimulus_length) {
        //     end_experiment();
        //     return;
        // }
        ...
        // if (!trial_page.checkTrialNumValidity()) {
        //     trial_page.clearResponse();
        //     run_single_trial(curr_trial_page_index + 1);
        // } else {
        //     start_time = new Date().getTime();
    ...
    let register_response = function () {
        ...
        let trial_left_img = trial_page.getTrialOptionLeftImageName();
        let trial_right_img = trial_page.getTrialOptionRightImageName();
        let trial_left_detail = trial_page.getTrialOptionLeftDetail();
        let trial_right_detail = trial_page.getTrialOptionRightDetail();

        // let true_stimulus_length = 16
        // if (first_part === "action") {
        //     true_stimulus_length = 20;
        // }
        //
        // let display_trial_number = trial_page.getCurrentTrialDisplayNum();
        // if (EXPERIMENT_PART === 2) {
        //     display_trial_number += true_stimulus_length;
        // }

        let value = trial_page.getSliderValue();
        // let value = trial_page.getUserSelection();
        ...
        psiTurk.recordTrialData({
            ...
            'TrialLeftImageName': trial_left_img,
            'TrialRightImageName': trial_right_img,
